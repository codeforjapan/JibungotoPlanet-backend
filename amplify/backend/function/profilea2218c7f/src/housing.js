...
var estimateHousing = function (dynamodb, housingAnswer, mobilityAnswer, footprintTableName, parameterTableName) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_o) {
        switch (_o.label) {
            ...
            case 8:
                electricitySeason = _o.sent();
                mobilityElectricityAmount = 0;
                if (!((mobilityAnswer === null || mobilityAnswer === void 0 ? void 0 : mobilityAnswer.hasPrivateCar) &&
                    (((_e = mobilityAnswer === null || mobilityAnswer === void 0 ? void 0 : mobilityAnswer.carIntensityFactorKey) === null || _e === void 0 ? void 0 : _e.startsWith('phv_')) ||
                        ((_f = mobilityAnswer === null || mobilityAnswer === void 0 ? void 0 : mobilityAnswer.carIntensityFactorKey) === null || _f === void 0 ? void 0 : _f.startsWith('ev_'))) &&
                ...
                return [4 /*yield*/, getData('car-intensity-factor', mobilityAnswer.carIntensityFactorKey.replace('_driving-factor', '_electricity-intensity'))];
            case 9:
                electricityData = _o.sent();
                mobilityElectricity = ((_g = electricityData === null || electricityData === void 0 ? void 0 : electricityData.Item) === null || _g === void 0 ? void 0 : _g.value) || 1;
                return [4 /*yield*/, getData('car-charging', mobilityAnswer.carChargingKey)];
            case 10:
                chargingData = _o.sent();
                mobilityCharging = ((_h = chargingData === null || chargingData === void 0 ? void 0 : chargingData.Item) === null || _h === void 0 ? void 0 : _h.value) || 1;
            ...
            case 11:
                estimationAmount.electricity.value =
                    (housingAnswer.electricityMonthlyConsumption *
                        ((_j = electricitySeason.Item) === null || _j === void 0 ? void 0 : _j.value)) /
                        residentCount -
                        mobilityElectricityAmount;
            ...
            case 14:
                ...
                gasParam =
                    (housingAnswer.gasMonthlyConsumption *
                        (((_k = gasSeason.Item) === null || _k === void 0 ? void 0 : _k.value) || 1) *
                        (((_l = gasFactor.Item) === null || _l === void 0 ? void 0 : _l.value) || 1)) /
                        residentCount;
                _o.label = 15;
            case 15:
            ...
            case 18:
                keroseneData = _o.sent();
                estimationAmount.kerosene.value =
                    ((((_m = keroseneData === null || keroseneData === void 0 ? void 0 : keroseneData.Item) === null || _m === void 0 ? void 0 : _m.value) || 1) *
